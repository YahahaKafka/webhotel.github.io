...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="kapka:info@example.com">INFO@PASTAIKAN.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>083838733755</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">PASTA <span>IKAN</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">PASTA IKAN</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our Hotel Facility</h3> 
						   <p class="about-para-w3ls">Lorem Ipsum is simply dummy text of the printing and typesetting industry.Lorem Ipsum is simply dummy text of the printing and typesetting industry.Lorem Ipsum is simply dummy text of the printing and typesetting industry.Sed tempus vestibulum lacus blandit faucibus. Nunc imperdiet, diam nec rhoncus ullamcorper, nisl nulla suscipit ligula, at imperdiet urna</p>
...
<div class="advantages">
	<div class="container">
		<div class="advantages-main">
				<h3 class="title-w3-agileits">HOtel Pasta Ikan</h3>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>083838733755</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="kapka:name@gianadit.com">INFO@PASTAIKAN.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Sukorejo, Kendal, Jawa Tengah</p>
			...
			<iframe src="https://www.google.com/maps/place/Kendal,+Kendal+Regency,+Central+Java/@-6.9248381,110.2033311,14z/data=!3m1!4b1!4m6!3m5!1s0x2e705c4425e18fa5:0x1afaf231d513dba!8m2!3d-6.9318012!4d110.2028022!16s%2Fg%2F12215rhl?entry=ttu" ></iframe>
		</div>
		<div class="clearfix"></div>
	</div>
</section>
<!-- /contact -->
			<div class="copy">
		        <p>© 2024 PASTAIKAN . All Rights Reserved | Design by <a href="index.php">Gian & Adit</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
